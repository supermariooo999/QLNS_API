...
class UpdateLoaiNghiRequest extends FormRequest
{
    /**
    ...
    {
        $loaiNghiId = $this->route('id') ?? $this->route('loai_nghi') ?? $this->route('loaiNghi');
        ...
        return [
            ...
            'ten_loai' => 'sometimes|required|string|max:255',
